...
execute_process(
  COMMAND "/bin/git" show-ref "54c03b21f763fa775a4c0643a9d8326342873179"
  WORKING_DIRECTORY "/home/noah/.emacs.d/elpa/vterm-20201113.1531/build/libvterm-prefix/src/libvterm"
...
# yet).
execute_process(
  COMMAND "/bin/git" rev-list --max-count=1 "${git_tag}"
  WORKING_DIRECTORY "/home/noah/.emacs.d/elpa/vterm-20201113.1531/build/libvterm-prefix/src/libvterm"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      execute_process(
        COMMAND "/bin/git" checkout "${git_remote}/${git_tag}"
        WORKING_DIRECTORY "/home/noah/.emacs.d/elpa/vterm-20201113.1531/build/libvterm-prefix/src/libvterm"
        RESULT_VARIABLE error_code
        )
      if(error_code)
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/noah/.emacs.d/elpa/vterm-20201113.1531/build/libvterm-prefix/src/libvterm'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/noah/.emacs.d/elpa/vterm-20201113.1531/build/libvterm-prefix/src/libvterm'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
    ...
    execute_process(
      COMMAND "/bin/git" checkout "${git_tag}"
      WORKING_DIRECTORY "/home/noah/.emacs.d/elpa/vterm-20201113.1531/build/libvterm-prefix/src/libvterm"
      RESULT_VARIABLE error_code
      )
    if(error_code)
